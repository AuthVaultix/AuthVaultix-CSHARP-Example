...
//    {
//        private const string DEFAULT_API_URL = "https://api.authvaultix.com/api/1.0/"; //apiUrl.TrimEnd('/') + "/"; 
...
//        public UserInfo CurrentUser { get; private set; } //get user deta 
//        public string LastMessage { get; private set; } // feach logs
//        public string LastResponseMessage { get; private set; } // send chat
//        public UserInfo UserData { get; private set; } //caht info
...
//        private string EncKey; // sentKey-secret
...
//            Initialized = true;
//            UseFullKey = true;   // after init, switch mode
...
//            return json.response; // ⭐ actual variable data
//        }
...
//            if (!json.success)
//            {
//                // exception optional (login jaisa behaviour chaho to)
//                throw new Exception(json.message);
//            }
//        }
...
//            return json.users; // ⭐ list of online users
//        }
...
//            // success case (KeyAuth style)
//            MessageBox.Show(LastMessage);                 // server ka message
...
//    //======================================================================== register user deta   END ========================================================================


//    //======================================================================== login user deta   START ======================================================================
